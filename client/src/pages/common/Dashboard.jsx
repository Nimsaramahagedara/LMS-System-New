      ...
      const designedNotices = allNotices.data.map((el, index) => {
        ...
        return (
          <div className="flex items-center justify-start py-2 gap-2 cursor-pointer hover:bg-gray-300 px-1 relative">
            ...
            <p className="text-xs text-right text-gray-400 absolute bottom-0 right-0">
              {formattedDate}
            </p>
          </div>
        );
      ...
      <AppBar position="absolute" open={open}>
        ...
        <ClickOutHandler onClickOut={handleClickOut}>
          <Box
            ...
            visibility={notiOpen ? "visible" : "hidden"}
          >
            <List component="nav" sx={{ width: "300px" }}>
              ...
              <React.Fragment>{notices}</React.Fragment>
              <Divider sx={{ my: 1 }} />
            </List>
          </Box>
        </ClickOutHandler>
